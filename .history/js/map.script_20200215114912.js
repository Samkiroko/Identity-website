...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(-1.2316057,36.8720804,),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(-1.2316057,36.8720804,),
				optimized: false,
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			...
			infowindow4 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>Mountain Mall Building Third Floor, suite No. 6 Thika Road<br>'
			});
